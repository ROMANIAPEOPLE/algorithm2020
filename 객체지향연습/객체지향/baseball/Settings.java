...
public class Settings { //유저가 뽑은 번호 생성
    public baseball.Numbers createdUserNumber(String input) {
        ...
        return new baseball.Numbers(user);
    }

    public baseball.Numbers createdComputerNumbers(){
        ...
        return new baseball.Numbers(computer);
